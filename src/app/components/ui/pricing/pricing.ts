...
export class Pricing {
   ...
   * @protected
   */
  protected currentAmount = signal(11.88 * 4);
  ...
  public plans = [
    {
      ...
      features: [
        ...
        { text: 'Projets par style de jeu (shoot\'em up, platformer, rpg…)', available: false },
        { text: 'Projets classés par contenu technique ASM', available: false },
        { text: 'Progression guidée par tâches et validation de phases', available: false },
        { text: 'Prise de notes par phase', available: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Plusieurs proposition de projets (shoot\'em up, platformer, rpg…)', available: false },
        { text: 'Projets classés par contenu technique ASM', available: false },
        { text: 'Progression guidée par tâches et validation de phases', available: false },
        { text: 'Prise de notes par phase', available: false },
        { text: 'Archiver les articles en PDF', available: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Musique midi/cubase .MID, .SND', available: true },
        { text: 'Samples audio .RAW, .AVR', available: true },
        { text: 'Projets par style de jeu (shoot\'em up, platformer, rpg…)', available: true },
        { text: 'Projets classés par contenu technique ASM', available: true },
        { text: 'Progression guidée par tâches et validation de phases', available: true },
        { text: 'Prise de notes par phase', available: true },
